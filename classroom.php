...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  switch ($_POST['saveType']) {
    case 'Add':
      $sqlAdd = "insert into classroom (room_building) value (?)";
    ...
    case 'Edit':
      ...
      $stmtEdit->execute();
      echo '<div class="alert alert-success" role="alert">Classroom edited.</div>';
      break;
    case 'Delete':
      $sqlDelete = "delete from classroom where school_id=?";
      $stmtDelete = $conn->prepare($sqlDelete);
      $stmtDelete->bind_param("i", $_POST['iid']);
      $stmtDelete->execute();
      echo '<div class="alert alert-success" role="alert">Classroom deleted.</div>';
      break;
  }
}
?>
...
<?php
$sql = "SELECT room_num, room_building from classroom";
...
?>
          ...
          <tr>
            ...
            <td>
              ...
              <div class="modal fade" id="editClassroom<?=$row["room_num"]?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="editClassroom<?=$row["room_num"]?>Label" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h1 class="modal-title fs-5" id="editClassroom<?=$row["room_num"]?>Label">Edit Classroom</h1>
